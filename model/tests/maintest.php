...
{   
    ...
    public function testEditArticle()
    {
        ...
        $user_id    = 1;
        $article_id = 1;
        $result1    = editArticle($data1, PDOStart(), $user_id, $article_id);
    ...
    public function testEditArticleAddTag()
    {
        ...
        $user_id    = 1;
        $article_id = 1;
        $result     = editArticle($data1, PDOStart(), $user_id, $article_id);
    ...
    *
    ...
    public function testEditArticleNullFormaltext()
    {
        ...
        $user_id    = 1;
        $article_id = 1;
        editArticle($data2,PDOStart(),$user_id,$article_id);
    }
    ...
    public function testEditArticleNullColumn()
    {
        ...
        $user_id    = 1;
        $article_id = 1;
        editArticle($data3,PDOStart(),$user_id,$article_id);
    }
    ...
    public function testDeleteArticle()
    {
        $user_id    = 1;
        $article_id = 1;
        $result     =  deleteArticle (PDOStart(), $user_id, $article_id);
